...
| Corpus dispatch | Rust scenario registry and Mise catalog | `check:scenarios`; `corpus:all` | 93 proofs exactly once: 65 A/B/C plus 28 corner proofs; unique public task names and no legacy wrapper scripts. This is dispatch evidence, not proof that every runtime journey passed. |
